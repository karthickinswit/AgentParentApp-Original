...
export async function getBroadCastList() {
  return new Promise((resolve, reject) => {
    var url =
      'https://b0b3-210-18-155-241.in.ngrok.io/MeOnCloud/chatbird/api/broadcast?name=&from=0&perPage=20&fromDate=2023-03-07T18:30:00.000Z&toDate=2023-03-15T18:29:00.000Z';
    const xhr = new XMLHttpRequest();
    xhr.open('GET', url);
    xhr.setRequestHeader('authentication-token', Variables.TOKEN);
    xhr.setRequestHeader('Content-Type', 'application/json');
    ...
    var testPayload = {
      ...
      message: {
        template: {
          ...
          media: {
            type: 'IMAGE',
            url: 'https://b0b3-210-18-155-241.in.ngrok.io/MeOnCloud/drive/docs/641808be725d0417bb2315f5',
          },
        },
      },
    };
